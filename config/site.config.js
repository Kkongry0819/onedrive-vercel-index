...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'Nangong@nangong.onmicrosoft.com',
  ...
  email: 'mailto:dreamskiff@qq.com',
